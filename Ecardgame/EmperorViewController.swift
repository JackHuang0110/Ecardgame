...
//  Ecardgame
//
//  Created by Jack Huang on 2018/8/31.
...
class EmperorViewController: UIViewController {
    ...
    @IBOutlet weak var emperorButton: UIButton!
    ...
    var Slavecards = ["citizen5", "citizen6", "citizen7", "citizen8", "slave"]
    var answer = [String]()
    ...
    @IBAction func citizenPicked1(_ sender: UIButton) {
        ...
        aiPickCard.image = UIImage(named: "\(Slavecards[0])")
        answer = [Slavecards[0]]
        switch answer {
        case ["slave"]:
    ...
    @IBAction func citizenPicked2(_ sender: UIButton) {
        ...
        aiPickCard.image = UIImage(named: "\(Slavecards[1])")
        answer = [Slavecards[1]]
        switch answer {
        case ["slave"]:
            winLabel.isHidden = false
    ...
    @IBAction func citizenPick3(_ sender: UIButton) {
        ...
        aiPickCard.image = UIImage(named: "\(Slavecards[2])")
        answer = [Slavecards[2]]
        switch answer {
        case ["slave"]:
            winLabel.isHidden = false
    ...
    @IBAction func citizenPick4(_ sender: UIButton) {
        ...
        aiPickCard.image = UIImage(named: "\(Slavecards[3])")
        answer = [Slavecards[3]]
        switch answer {
        case ["slave"]:
            winLabel.isHidden = false
    ...
    @IBAction func emperorPicked(_ sender: UIButton) {
        
        emperor.isHidden = true
        drawLabel.isHidden = true
        playerPickCard.image = UIImage(named: "emperor")
        aiPickCard.image = UIImage(named: "\(Slavecards[4])")
        answer = [Slavecards[4]]
        switch answer {
        case ["slave"]:
            loseLabel.isHidden = false
